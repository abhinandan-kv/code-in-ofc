...
//             <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Best Ecommerce</span>
//           </a>
//           <button
...
const Navbar = () => {
  ...
  // conditional rendering has to be their for signup and login
