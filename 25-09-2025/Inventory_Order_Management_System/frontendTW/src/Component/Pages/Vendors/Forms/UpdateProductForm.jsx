...
const UpdateProductForm = ({ product, onSubmit }) => {
  ...
  const initialValues = {
    productName: product?.productName || "",                      //although it was not required here becz no sending product details form parent ( i should have but i am doing it here its here for best practice) becz data should be visible to user when updating 
    ...
    const fetchCategories = async () => {
      try {
        ...
        if (product?.productCategory) {
          const selected = res.data.find((c) => c.name === product.productCategory);
