...
import { fetchNotes, notesAdd } from "../app/features/noteSlice";
  ...
  return (
    <div className="relative max-w-sm">
      ...
      >
        ...
        <p className="font-normal text-gray-600 dark:text-gray-400">{data}</p>
        <RxCrossCircled className="absolute top-0 right-0 text-red-500 text-2xl hover:text-red-800 cursor-pointer" />
      </div>
    </div>
  );
}
