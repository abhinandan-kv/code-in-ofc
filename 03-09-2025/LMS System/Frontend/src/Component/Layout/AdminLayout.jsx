...
import profilelogo from "../../assets/profilepic.jpg";
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              <Link to="/" className="flex items-center ms-2 md:me-24">
                ...
                <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Best LMS</span>
              </Link>
            </div>
            ...
            <div className="flex items-center">
              <button type="button" className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
                ...
                <img className="w-8 h-8 rounded-full" src={profilelogo} alt="user photo" />
              </button>
            </div>
          </div>
        </div>
      ...
      >
        <div className="h-full flex flex-col justify-between px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <Link to="/admin/users" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
            ...
            <li>
              <Link to="/admin/books" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                <FiBookOpen className="w-5 h-5 text-gray-500" />
                <span className="ms-3">All Books</span>
              </Link>
            </li>
            <li>
              <Link
                ...
                className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
              >
                <LuBookLock className="w-5 h-5 text-gray-500" />
                <span className="ms-3">Books Issued</span>
              </Link>
            </li>
            <li>
              <Link
                to="/admin/issue/history"
                className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
              >
                <GiBookshelf className="w-5 h-5 text-gray-500" />
                <span className="ms-3">Books Issued History</span>
              </Link>
            </li>
          </ul>
