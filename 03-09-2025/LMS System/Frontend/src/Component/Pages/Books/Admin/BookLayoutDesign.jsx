...
const BookLayoutDesign = ({ data }) => {
  ...
  async function handleDeleteClick(evt) {
    ...
    if (confirm) {
      const result = await axios.delete(`http://localhost:9000/admin/delete/${bookId}`, { withCredentials: true });
      //   console.log(result);
      if (result.status) {
...
export default BookLayoutDesign;
