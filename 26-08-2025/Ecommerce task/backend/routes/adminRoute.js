...
import { listSingleUser,pendingRequestUsers, userCounts,listSingleProduct, activateAccount, deleteAProduct, deleteUser, forceListAllProduct, forceListAllUsers, listAllUsers, readAuditLogs, addCategory, addSubCategory } from "../controllers/adminController.js"
...
adminRouter.post("/category", verifyToken, addCategory);
adminRouter.post("/subcategory", verifyToken, addSubCategory);
