...
import { FiHome, FiLogOut, FiBookOpen } from "react-icons/fi";
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="ms-3">Issued Books</span>
              </Link>
            </li>
            <li>
              <Link
                to="/user/issued/history "
                className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
              >
                <GiBookshelf className="w-5 h-5 text-gray-500" />
                <span className="ms-3">Issued History</span>
              </Link>
            </li>
          </ul>
