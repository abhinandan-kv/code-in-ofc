...
const NewBookForm = ({ formClose }) => {
  const [bookData, setBookData] = useState({ bookName: null, authorName: null, publicationName: null, publicationYear: null, availability: null });
  ...
  async function handleSubmit(evt) {
    ...
    const addNewBook = await axios.post("http://localhost:9000/admin/addbook", { ...bookData }, { withCredentials: true });
  ...
  return (
    <form className="max-w-md mx-auto">
      <h5 className="mb-6 text-lg font-normal text-gray-900 lg:text-xl   dark:text-gray-400 underline underline-offset-2 ">Add New Book</h5>
