...
import { FiHome, FiBox, FiUsers, FiUserCheck, FiClipboard, FiLogOut } from "react-icons/fi";
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              <Link to="/" className="flex items-center ms-2 md:me-24">
                ...
                <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Best Ecommerce</span>
              </Link>
            </div>
      ...
      >
        <div className="h-full flex flex-col justify-between px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <Link to="/vendor" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
            ...
            <li>
              ...
              >
                <FiBox className="w-5 h-5 text-gray-500" />
                <span className="ms-3">Category Mangement</span>
              </Link>
            </li>
            <li>
              <Link
