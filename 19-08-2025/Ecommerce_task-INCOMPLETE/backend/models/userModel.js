...
const UserTable = sequelize.define(
  "UserTable",
  {
    ...
    profilePic: {               //handle later
      type: DataTypes.BLOB('medium') //this can be changed by user after signup approval from admin(that is successfull account creation) not good practice to give unneccsary stroage can be spammed
    },
    role: {
