...
const TeacherStudentCard = ({ data }) => {
  ...
  const [assignSubForm, setAssignSubForm] = useState(false);
  ...
  async function handleAssignSubject(e) {
    setAssignSubForm(!assignSubForm);
  }
  ...
  return (
    <>
      <div className="w-full max-w-sm  bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <div className="flex justify-end px-4 pt-4">
          ...
          {dropdown ? (
            <div
              id="dropdown"
              className="z-10 absolute text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700"
              ref={wrapperRef}
            >
      ...
      {editForm && <EditSubjectForm />}
      {assignSubForm && <AssignSubjectForm />}
    </>
  );
};
...
function EditSubjectForm() {
  return (
    <>
      <div className="z-10 absolute w-screen h-screen overflow-hidden flex items-center justify-center bg-white/30 backdrop-blur-md ">
        <form className="min-w-lg  bg-slate-800 text-white p-2 ">
...
function AssignSubjectForm() {
  return (
    <>
      <div className="z-10 absolute w-full overflow-hidden flex items-center justify-center ">
        <form className="max-w-md mx-auto bg-slate-800 text-white p-2 ">
          <div className="relative z-0 w-full mb-5 group">
            <input
              type="email"
              name="floating_email"
