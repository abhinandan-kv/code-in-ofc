...
import { addNewProduct, addVarient, getCategories, listAllProducts, listAllUserOrders, listSingleProduct, removeProduct, totalRevenueMade, updateOrderStatus, updateProduct, updateProductImage } from "../controllers/vendorController.js";
...
vendorRouter.get('/singleproduct/:id', verifyToken, listSingleProduct)
...
vendorRouter.get("/categories",  verifyToken, getCategories);

// vendorRouter.get('/subcategory/:id', verifyToken, getSubCatgory)

//varient extension
vendorRouter.post('/addvarient', verifyToken, addVarient)
