...
userRouter.post("/changepasswordthroughtoken", verifyToken, handleEmailToken);  // removed :token becz now no need of it
...
userRouter.post("/ordercompletecart", verifyToken, userWholeCartOrder);

userRouter.get('/orders', verifyToken, getUserOrders)


//userfilters sort
userRouter.get("/product", verifyToken, getFilteredAndSortedProducts);

userRouter.get('/twofactorauthenticationstatus', verifyToken, twoFAStatus)
